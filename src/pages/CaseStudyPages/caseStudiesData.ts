export const caseStudiesData = [
  ...
  {
    id: 'pcma-2024-cema-summit', // <-- Unique ID
    name: 'PCMA 2024 CEMA Summit ',
    tagline: 'Highlighting the value of audience engagement for event industry professionals ',
  ...
  {
    id: 'surescripts-sales-kickoff', // <-- Unique ID
    name: "Surescript's Sales Kickoff",
    tagline: 'Turning an SKO into an action-packed and collaborative experience',
