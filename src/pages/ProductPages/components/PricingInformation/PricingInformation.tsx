...
const PricingInformation = ({ pricing }: PricingInformationProps) => {
  return (
    <section className={styles.pricingWrapper}>
      ...
      <p>
        We can’t give an exact quote without knowing more about your event, but we’re confident we
        can add immediate experiential value across a wide range of budgets — that’s kind of our
        thing.
        <br />
        <br />
        Bundling multiple products usually lowers the cost per product and allows us to create a
        more integrated, high-impact experience.
      </p>
      ...
      <div className={styles.disclaimer}>
        Pricing does not include shipping or travel and accommodation costs for any onsite team
        members.
      </div>
    </section>
  );
